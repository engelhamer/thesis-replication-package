---
title: "Map quality analysis - Point to point arena"
...
hist
ggexport(hist, filename = "map_occupancy_point_to_point_histogram.pdf")
```
...
bxp
ggexport(bxp, filename = "map_occupancy_point_to_point_box.pdf")
```
...
hist
ggexport(hist, filename = "map_corner_count_point_to_point_histogram.pdf")
```
...
bxp
ggexport(bxp, filename = "map_corner_count_point_to_point_box.pdf")
```
...
hist
ggexport(hist, filename = "map_enclosed_area_count_point_to_point_histogram.pdf")
```
...
bxp
ggexport(bxp, filename = "map_enclosed_area_count_point_to_point_box.pdf")
```
